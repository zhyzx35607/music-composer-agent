...
public class MusicController {
    ...
    private Map<String, Object> buildGenerateResponse(MusicVersion v) throws JsonProcessingException {
        ...
        resp.put("midi_url", "/outputs/" + v.getVersionId() + "/" + v.getVersionId() + ".mid");
        resp.put("audio_url", "/outputs/" + v.getVersionId() + "/" + v.getVersionId() + ".wav");
    ...
    private Map<String, Object> buildVersionDetail(MusicVersion v) {
        ...
        detail.put("midi_url", "/outputs/" + v.getVersionId() + "/" + v.getVersionId() + ".mid");
        detail.put("audio_url", "/outputs/" + v.getVersionId() + "/" + v.getVersionId() + ".wav");

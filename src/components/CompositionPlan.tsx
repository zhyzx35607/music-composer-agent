...
import type { CompositionPlan } from '../types/api'
...
export default function CompositionPlan({ plan }: CompositionPlanProps) {
  const rows = [
    { label: '主题', key: 'theme' as const },
    { label: '风格', key: 'style' as const },
    { label: '情绪', key: 'mood' as const },
    { label: '速度', key: 'tempo' as const },
    { label: '调式', key: 'key' as const },
    { label: '乐器', key: 'instruments' as const },
    { label: '结构', key: 'structure' as const },
  ]
